...
| Step 2   | [基礎編](./docs/gitlab-ci/02-basic/README.md)    | pipeline の基本構造・`stages` / `jobs`                |
| Step 3   | [応用編](./docs/gitlab-ci/03-advanced/README.md) | 条件分岐・variables・secrets・artifact                |
| Step 4   | [実践編（CI）](./docs/gitlab-ci/04-ci/README.md) | Terraform の fmt / validate / plan を CI で自動化する |
| Step 5   | [実践編（CD）](./docs/gitlab-ci/05-cd/README.md) | Terraform apply を CD で実装する                      |
